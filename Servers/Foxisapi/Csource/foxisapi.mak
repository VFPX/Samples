...
CPP_PROJ=/nologo /MT /W3 /GX /O2 /D "WIN32" /D "NDEBUG" /D "_WINDOWS"\
 /Fp"$(INTDIR)\foxisapi.pch" /YX /FD /c /GS /Zi
CPP_OBJS=.
CPP_SBRS=.
...
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 ...
 /pdb:"$(OUTDIR)\foxisapi.pdb" /DEBUG:FULL /machine:I386 /def:".\foxisapi.def"\
 /out:"$(OUTDIR)\foxisapi.dll" /implib:"$(OUTDIR)\foxisapi.lib" /SAFESEH /DEBUGTYPE:cv,fixup 
DEF_FILE= \
	".\foxisapi.def"
LINK32_OBJS= \
	"$(INTDIR)\foxisapi.obj" \
...
CPP_PROJ=/nologo /MTd /W3 /Gm /GX /Zi /Od /D "WIN32" /D "_DEBUG" /D "_WINDOWS"\
 /FR /Fp"$(INTDIR)\foxisapi.pch" /YX /FD /c /GS
CPP_OBJS=.
CPP_SBRS=.
