...
*--------------------------------------------------------------------------------------------------------------------------------------------------------
*< FOXBIN2PRG: Version="1.19" SourceFile="login.dbf" /> (Solo para binarios VFP 9 / Only for VFP 9 binaries)
*
...
<TABLE>
	...
	<indexFile>LOGIN.CDX</indexFile>

	<INDEXES>
		<INDEX>
			<TagName>USERID</TagName>
	...
	<RECORDS>
		...
		<RECORD>
			<USERID>Randy</USERID>
			<PASSWORD>FoxPro</PASSWORD>
		</RECORD>

		<RECORD>
			<USERID>Sophia</USERID>
			<PASSWORD>VFP</PASSWORD>
		</RECORD>

		<RECORD>
			<USERID>Yan Ming</USERID>
