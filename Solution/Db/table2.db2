...
*--------------------------------------------------------------------------------------------------------------------------------------------------------
*< FOXBIN2PRG: Version="1.19" SourceFile="table2.dbf" /> (Solo para binarios VFP 9 / Only for VFP 9 binaries)
*
...
<TABLE>
	...
	<FIELDS>
		<FIELD>
			...
			<LongTableName>TABLE2</LongTableName>
	...
	<indexFile>TABLE2.CDX</indexFile>
