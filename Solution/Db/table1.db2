...
*--------------------------------------------------------------------------------------------------------------------------------------------------------
*< FOXBIN2PRG: Version="1.19" SourceFile="table1.dbf" /> (Solo para binarios VFP 9 / Only for VFP 9 binaries)
*
...
<TABLE>
	...
	<FIELDS>
		<FIELD>
			...
			<LongTableName>TABLE1</LongTableName>
	...
	<indexFile>TABLE1.CDX</indexFile>
